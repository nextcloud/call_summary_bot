OC.L10N.register(
    ...
    "- Any message starting with a `-` or `*` during a call will be recognized as a task, you can also post multiple tasks in a single message, just put each on its own line starting with a `-` or `*`\n- At the end of the call, the bot will summarize it and list all the attendees as well as the tasks in a markdown chat message" : "- Qualquer mensagem começando com `-` ou `*` durante uma chamada será reconhecida como uma tarefa, você também pode postar várias tarefas em uma única mensagem, basta colocar cada uma em sua própria linha começando com `-` ou `* ` - No final da chamada, o bot irá resumir e listar todos os participantes, bem como as tarefas em uma mensagem de bate-papo de remarcação"
},
