OC.L10N.register(
    ...
    "Tasks" : "Tarefas",
    "Call summary bot" : "Bot do resumo da chamadas",
    "- Any message starting with a `-` or `*` during a call will be recognized as a task, you can also post multiple tasks in a single message, just put each on its own line starting with a `-` or `*`\n- At the end of the call, the bot will summarize it and list all the attendees as well as the tasks in a markdown chat message" : "– Calquera mensaxe que comece cun `-` ou cun `*` durante unha chamada será recoñecida coma unha tarefa, tamén pode publicar varias tarefas nunha única mensaxe, só ten que poñer cada unha na súa propia liña comezando cun `-` ou cun `* `\n– Ao final da chamada, o bot resumirao e enumerará todos os asistentes, así como as tarefas nunha mensaxe de parola en markdown"
},
